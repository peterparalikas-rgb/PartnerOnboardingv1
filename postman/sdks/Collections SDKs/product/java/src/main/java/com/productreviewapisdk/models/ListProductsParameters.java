...
public class ListProductsParameters {
  ...
  public static class ListProductsParametersBuilder {

    private JsonNullable<String> page = JsonNullable.undefined();

    @JsonProperty("page")
    public ListProductsParametersBuilder page(String value) {
    ...
    @JsonProperty("limit")
    public ListProductsParametersBuilder limit(String value) {
      this.limit = JsonNullable.of(value);
      return this;
    }

    @JsonAnySetter
    public ListProductsParametersBuilder additionalProperties(String key, Object value) {
